...
export default function Home() {
  ...
  return (
    <div className="px-2">
      ...
      {/* Announcement */}
      <div className="mt-2">
        <div>ทางทีมผู้สร้างมีความตั้งใจจริง ที่จะทำให้เกิด Platform ที่รวบรวมข่าวสาร และเนื้อหาสาระต่างๆมาไว้ในที่เดียว โดยเริ่มต้นที่เรื่อง Cryptocurrency แต่ในอนาคตจะไม่ได้จำกัดเฉพาะเรื่อง Cryptocurrency  และสนับสนุนโปรเจค Defi ในประเทศไทย ซึ่งเกิดจาก Pain point ของผู้สร้างเอง กล่าวคือในปัจจุบันในโลก Defi มีข่าวสารมากมายกระจายอยู่ในหลายที่ โดยข่าวหรือเนื้อหาสาระไหนที่เป็นของใหม่ จะมีการประกาศข่าวอยู่เพียงแค่ไม่กี่ที่ เมื่อเรื่องนั้นได้รับความสนใจมากขึ้น จึงค่อยมีผู้ที่ประกาศเรื่องนั้นมากขึ้น หลังจากนั้นจึงส่งผลให้เรื่องเหล่านั้นถูกผลักดันขึ้นมาใน Social media ดังนั้นเป็นเรื่องที่ยากมากที่จะทราบข่าวหรือเนื้อหาสาระใหม่ๆได้ โดยอาศัยแค่การรออ่านข่าวที่เด้งขึ้นมาใน Social media และถ้าใช้วิธีการไล่อ่านข่าวทุกสำนัก ก็จะใช้เวลามาก</div>

        <div>ด้วยเหตุนี้ผู้พัฒนาจึงพยายามคิดหาวิธีการแก้ปัญหาดังกล่าว แต่ก็ต้องพบเจอกับปัญหาทางด้านเงินทุน และด้านการตลาด จึงเกิดความคิดที่อยากจะช่วยให้ผู้ที่มีความสามารถ มีไอเดีย มีแรงผลักดัน สามารถทำให้ไอเดียเหล่านั้นเกิดขึ้นจริงได้จากการที่มีผู้สนับสนุนแหล่งเงินทุน สนับสนุนทางด้านการตลาด และอื่นๆ</div>

        <div>หากทว่าก่อนหน้านี้ทางผู้พัฒนาพบว่าได้มีความเข้าใจที่คลาดเคลื่อนในตัวโครงการนี้กับบุคคลภายนอกดังนั้นเพื่อให้ทุกคนเข้าใจข้อมูลที่ครบถ้วน ทางเราได้ทำการรวบรวมข้อมูลที่เกี่ยวข้องกับโครงการนี้ดังต่อไปนี้</div>
        
        <div>ข้อที่คุณควรรู้ก่อนตัดสินใจ</div>
      </div>
      
      <ol className="list-decimal">
        
        <li>ขณะนี้ทางเราได้รับการสนับสนุนถึงเป้าหมายที่ได้ตั้งไว้ในตอนต้น จากผู้สนับสนุน 103 กระเป๋า เป็นจำนวน 13.333 BNB</li>
        <li>เราได้ทำการพัฒนาในส่วนของ Smart contract และได้นำขึ้น testnet แล้วโดยทุกคนสามารถเข้าร่วมการทดสอบได้โดยสมัครใจ มิได้บังคับให้เข้าร่วมการทดสอบ ผู้เข้าร่วมการทดสอบจำเป็นต้องมีความรู้ความชำนาญในการใช้ testnet ของ binance smart chain ในระดับที่ดี ทั้งนี้ทางทีมผู้พัฒนาจะไม่รับผิดชอบต่อความเสียหายที่เกิดขึ้นจากการเข้าร่วมการทดสอบ testnet สำหรับผู้ที่เข้าใจในข้อตกลงและความเสี่ยงของการทดสอบใน testnet แล้วสามารถเข้าร่วมการทดสอบการซื้อขายเหรียญ SafeThai ได้ที่ …</li>
        <li>ทางทีมผู้สร้างจะทำการลด Supply สูงสุดของเหรียญ SafeThai ลง 1 ล้านเท่า นั่นหมายความว่า Suppy สูงสุดของเหรียญ SafeThai จะมีเพียง 1,000,000,000 SafeThai ส่งผลให้จำนวนเหรียญ SafeThai ที่ควรจะได้รับลดลง 1 ล้านเท่า</li>
        <li>หลังจากนี้สิ่งที่เราจะทำต่อไปคือ จะทำการนำเงินที่ได้จากการสนับสนุนที่เหลือจากการคืนเงินครึ่งหนึ่งไปเป็นเงินทุนในการพัฒนาโปรเจค และอีกครึ่งหนึ่งไปทำการ Provide liquidity ใน PancakeSwap V2 เพื่อทำ IDO (Initial Dex Offering) แล้วทำการ Lock ไว้ 4 เดือน โดยจะทำการกระจายเหรียญจำนวน 8,000,000 SafeThai สำหรับทุกๆ 1 BNB ที่ได้รับการสนับสนุน เพื่อเป็นรางวัลตอบแทนแก่ผู้สนับสนุน และจะได้รับเหรียญภายใน 3 ชั่วโมง หลังจากที่ได้ทำการ Provide liquidity เข้าไปใน PancakeSwap V2 และเหรียญที่เหลือจะถูก Lock ไว้ใน Contract พิเศษ</li>
        ...
        <li>มูลค่าของเหรียญ SafeThai จะเป็นไปตามกลไกของระบบ AMM (Automated market maker) ซึ่งอยู่นอกเหนือขอบเขตอำนาจการควบคุมของผู้พัฒนา ซึ่งหมายความว่าทีมพู้พัฒนาไม่สามารถควบคุม และไม่สามารถการันตีผลกำไร และทีมผู้พัฒนาไม่จำเป็นต้องชดใช้เมื่อมีการขาดทุนเกิดขึ้น</li>
        <li>ในกรณีที่โปรเจคไม่ประสบความสำเร็จ มูลค่าของเหรียญ SafeThai ก็จะยังคงเป็นไปตามกลไกของระบบ AMM (Automated market maker) ซึ่งอยู่นอกเหนือขอบเขตอำนาจการควบคุมของผู้พัฒนาเช่นเดิม แต่จะมีความเสี่ยงที่ผู้ถือเหรียญ SafeThai จะขาดทุนสูง โดยผู้ถือเหรียญ SafeThai ได้รับทราบในความเสี่ยงนี้เป็นอย่างดี และรับทราบว่าผู้ถือเหรียญ SafeThai จะต้องรับผิดชอบต่อผลกำไรหรือขาดทุนทั้งหมด และจะไม่เรียกร้องให้ทีมผู้พัฒนาชดใช้เมื่อมีการขาดทุนเกิดขึ้น</li>
        ...
        <li>
          SafeThai จะมีการ Rebrand เกิดขึ้น โดยจะดำเนินการตาม Roadmap ดังต่อไปนี้ [[แปะ Roadmap]]
        </li>
        <li>เราได้มีการจัดทำ Business model ของการ Rebrand โปรเจค โดยใช้ Lean canvas ขึ้นมาเบื้องต้น เพื่อให้ทุกท่านเห็นภาพรวมของการทำธุรกิจเพิ่มเติมดังนี้ [[แปะ Lean Canvas]]</li>
        <li>ผู้พัฒนาได้ใส่เงินเป็นจำนวน 1.01 BNB ตาม transaction นี้ และ transaction นี้ โดยถ้าหากมีการ Refund เกิดขึ้น จะนำเงินส่วนนี้ไปใช้จ่ายเป็นค่าธรรมเนียมในการ Refund โดยผู้พัฒนาจะได้รับเหรียญ SafeThai ในปริมาณเท่ากับผู้สนับสนุนทั่วไป</li>
        <li>ถ้าหากยอดเงินคงเหลือหลังจาก Refund น้อยกว่า 5 BNB จะระงับการปล่อยเหรียญชั่วคราว และจะทำการเปิดให้ Refund ได้ จนกว่าการ Preorder NFT รอบ 1 จะขายหมด หรือพัฒนาระบบเสร็จสิ้น ถ้าหากเข้ากรณีนี้ผู้ที่ซื้อ Preorder NFT รอบ 1 จะได้รับการ Airdrop เหรียญ SafeThai ทันทีหลังจากขายหมด แทนที่จะต้องรอการเปิดตัวของระบบที่ได้รับการ Rebrand</li>
        ...
        <li>ข้อมูลที่ให้มาทั้งหมดเพื่อให้ทุกคนพิจารณาว่าอยากจะสนับสนุนต่อหรือไม่ ถ้าไม่อยากสนับสนุนต่อสามารถที่จะกด Refund เพื่อขอคืนเงินที่สนับสนุนมาแล้วได้ แต่ถ้าอยากสนับสนุนต่อ ทางทีมผู้พัฒนาก็จะทำการพัฒนาต่อตาม Roadmap ที่ได้กล่าวไว้ข้างต้น</li>
        <li>ถ้าหากไม่ทำการตัดสินใจภายใน 2 วันจะถือว่าท่านเลือกที่จะสนับสนุนต่อ เว้นแต่ว่ายอดเงินคงเหลือหลังจาก Refund น้อยกว่า 5 BNB</li>

      </ol>
      
      <div>ทางผู้พัฒนาขอขอบคุณทุกท่านที่ให้ความไว้วางใจและสนับสนุนโครงการ SafeThai ในครั้งนี้ครับ</div>
