    ...
    <div className="container mx-auto px-4">
      ...
      <div className="mt-2 text-white text-center">
        ...
        <div className="my-3">
          ...
          ทางผู้พัฒนาจะทำการคืนเงินให้กับผู้สนับสนุนทุกคนภายในวันที่ 9 พฤษภาคม เว้นแต่ว่าผู้สนับสนุนท่านนั้นจะแสดงเจตจำนงอย่างชัดเจนว่าจะไม่ขอคืนเงิน ภายในวันที่ 7 พฤษภาคม เวลา 21:00 ซึ่งถือเป็นการสนับสนุนโดยที่ไม่หวังผลตอบแทน ทั้งนี้ถึงแม้จะจำเป็นต้องคืนเงินให้กับผู้สนับสนุนทุกคน ทีมผู้พัฒนาก็จะยังคงพัฒนาต่อไป โดยจะมีการแก้ไขปัญหาด้านต่างๆ แล้วทำการเปิดอีกครั้งเมื่อ Product สมบูรณ์แบบแล้ว
        </div>
        ...
        <div className="my-3">
          ทั้งนี้ ถึงแม้ว่าจะคืนเงินให้กับทุกคน ทางผู้พัฒนาก็จะยังคงทำต่อไปครับ
        </div>
