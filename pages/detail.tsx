  ...
  return (
    <div className="md:px-8">
      ...
      <ol className="list-decimal text-white pl-8">
        ...
        <li>ถ้าหากมีการปล่อยเหรียญออกมา มูลค่าของเหรียญที่ปล่อยออกมา จะเป็นไปตามกลไกของระบบ AMM (Automated market maker) ซึ่งอยู่นอกเหนือขอบเขตอำนาจการควบคุมของผู้พัฒนา ซึ่งหมายความว่าทีมพู้พัฒนาไม่สามารถควบคุม และไม่สามารถการันตีผลกำไร และทีมผู้พัฒนาไม่จำเป็นต้องชดใช้เมื่อมีการขาดทุนเกิดขึ้น</li>
        <li>ในกรณีที่โปรเจคไม่ประสบความสำเร็จหลังจากปล่อยเหรียญออกมาแล้ว มูลค่าของเหรียญ ก็จะยังคงเป็นไปตามกลไกของระบบ AMM (Automated market maker) ซึ่งอยู่นอกเหนือขอบเขตอำนาจการควบคุมของผู้พัฒนาเช่นเดิม แต่จะมีความเสี่ยงที่ผู้ถือเหรียญจะขาดทุนสูง โดยผู้ถือเหรียญ ได้รับทราบในความเสี่ยงนี้เป็นอย่างดี และรับทราบว่าผู้ถือเหรียญจะต้องรับผิดชอบต่อผลกำไรหรือขาดทุนทั้งหมด และจะไม่เรียกร้องให้ทีมผู้พัฒนาชดใช้เมื่อมีการขาดทุนเกิดขึ้น</li>
        ...
        <li>ผู้พัฒนาได้ใส่เงินเป็นจำนวน 1.01 BNB ตาม <a className="underline" href="https://bscscan.com/tx/0x70ba873efe9b2a7612a4ee8cde2edb6f1d37b6da3aae0ee432cbd5763ad2747d" target="blank">transaction</a> นี้ และ <a className="underline" href="https://bscscan.com/tx/0x084cfe79a4fd6d1868752b61aa4ec6de9d4687b008912299b62a6bd05d12a25d" target="blank">transaction</a> นี้ โดยถ้าหากมีการ Refund เกิดขึ้น จะนำเงินส่วนนี้ไปใช้จ่ายเป็นค่าธรรมเนียมในการ Refund โดยผู้พัฒนาจะได้รับเหรียญ SafeThai ในปริมาณเท่ากับผู้สนับสนุนทั่วไป</li>
        <li>ถ้าหากยอดเงินคงเหลือหลังจาก Refund น้อยกว่า 7 BNB ทำการคืนเงินให้กับผู้สนับสนุนทุกคน</li>
        <li>ถ้าหากยอดเงินคงเหลือหลังจาก Refund เหลืออย่างน้อย 7 BNB ทางทีมผู้พัฒนาจะทำการปรับปรุง Branding ให้เร็วที่สุด และจะมีการปล่อยเหรียญออกมาอีกครั้ง หลังจากที่ได้ทำการปรับปรุง Branding และพัฒนาระบบเสร็จสิ้นแล้ว โดยจะมีการโปรโมทในตลาดที่ใหญ่กว่าเดิมมาก</li>
        ...
        <li>การปรับปรุง Branding และพัฒนาระบบให้สมบูรณ์ต้องใช้เวลามาก จึงต้องเลื่อนการเปิดเหรียญในวันที่ 9 พฤษภาคม ออกไปอย่างไม่มีกำหนด</li>
        <li>ถ้าหากไม่ทำการตัดสินใจภายใน 5 พฤษภาคม 2564 เวลา 21:00 จะถือว่าท่านเลือกที่จะสนับสนุนต่อ ทั้งนี้อาจมีการเปิดให้คืนเงินใหม่ในอนาคต</li>
      </ol>
