...
contract SafeThai is Context, IERC20, Ownable {
    ...
    event SetFundManager(address indexed oldFundManager, address indexed newFundManager);
    
    function setFundManager(address payable _fundManager) public {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x000000000000000000000000000000000000dEaD, // Burn liquidity instantly = no rug
            block.timestamp
        );
    }
